  ...
  return (
        <div>
            ...
            <p>We use Your Personal data to provide and improve the Service. By using
                ...
                with this Privacy Policy. This Privacy Policy has been created with the help of
                the&nbsp;
                <a href="https://www.privacypolicies.com/privacy-policy-generator/"
                    target="_blank" rel="noreferrer">Privacy Policy Generator</a>.</p>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Cookies</strong> are small files that are placed on Your
                        ...
                        the details of Your browsing history on that website among its many uses.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Third-party Social Media Service</strong> refers to any website
                        or any social network website through which a User can log in or create
                        an account to use the Service.</p>
                </li>
                <li>
            ...
            <ul>
                ...
                <li><strong>Flash Cookies.</strong> Certain features of our Service may use local
                    ...
                    the same browser settings as those used for Browser Cookies. For more information
            ...
            <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies
                ...
                #Use_Of_Cookies_Log_Files_And_Tracking"
                    target="_blank" rel="noreferrer">Privacy Policies website</a> article.</p>
            ...
            <ul>
                <li>
                    ...
                    <p>Purpose: These Cookies are essential to provide You with services
                        ...
                        of its features. They help to authenticate users and
            ...
            <ul>
                <li><strong>With Service Providers:</strong> We may share Your personal
                    information with Service Providers to monitor and analyze the use of our Service, to contact You.</li>
                ...
                <li><strong>With other users:</strong> when You share personal information or
                    ...
                    be viewed by all users and may be publicly distributed outside. If You interact with
                    ...
                    description of Your activity. Similarly, other users will be able to view descriptions
                    of Your activity, communicate with You and view Your profile.</li>
            ...
            <p>Our Service does not address anyone under the age of 13. We do not knowingly collect
                ...
                he age of 13 without verification of parental consent, We take steps to remove that
